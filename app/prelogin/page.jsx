...
const Prelogin = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#AF7026]">
      <div className="hidden lg:flex lg:w-1/2  items-center justify-center relative p-12 overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex flex-col ">
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="w-full max-w-3xl space-y-12 items-center justify-center p-4">
            <div className="text-start space-y-3">
              <h1 className="text-5xl font-bold text-white">
                Troque seus livros
                <br />
                com a facilidade do Bookly!
              </h1>
